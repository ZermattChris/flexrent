...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
            ...
            // -------------- Edited ------------------
			array( "name" => esc_html__("Custom HTML Panel 1",$themename),
                   "id" => $shortname."_html_panel_1",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Custom HTML Panel 1 on the homepage. ",$themename)
			),
                array( "name" => esc_html__("HTML Panel 1 Page",$themename),
                    "id" => $shortname."_home_page_html_panel_1",
                    "std" => "",
                    "type" => "select",
                    "desc" => esc_html__("Choose the page you would like to display in HTML Panel 1 Page Section on homepage. ",$themename),
                    "options" => $site_pages,
                    'et_array_for' => 'pages'),
                array( "name" => esc_html__("HTML Panel 1 section title",$themename),
                    "id" => $shortname."_panel_1_title",
                    "std" => 'HTML Panel 1',
                    "type" => "text",
                    "validation_type" => "nohtml",
                    "desc" => esc_html__("Here you can define HTML Panel 1 section title on homepage",$themename)
                ),
                array( "name" => esc_html__("HTML Panel 1 section description",$themename),
                    "id" => $shortname."_panel_1_description",
                    "std" => 'HTML Panel 1 description',
                    "type" => "text",
                    "validation_type" => "nohtml",
                    "desc" => esc_html__("Here you can define HTML Panel 1 section description on homepage",$themename)
                ),


            // HTML Panel 2
            array( "name" => esc_html__("Custom HTML Panel 2",$themename),
                "id" => $shortname."_html_panel_2",
                "type" => "checkbox",
                "std" => "on",
                "desc" => esc_html__("Custom HTML Panel 2 on the homepage. ",$themename)
            ),
                array( "name" => esc_html__("HTML Panel 2 Page",$themename),
                    "id" => $shortname."_home_page_html_panel_2",
                    "std" => "",
                    "type" => "select",
                    "desc" => esc_html__("Choose the page you would like to display in HTML Panel 2 Page Section on homepage. ",$themename),
                    "options" => $site_pages,
                    'et_array_for' => 'pages'),
                array( "name" => esc_html__("HTML Panel 2 section title",$themename),
                    "id" => $shortname."_panel_2_title",
                    "std" => 'HTML Panel 2',
                    "type" => "text",
                    "validation_type" => "nohtml",
                    "desc" => esc_html__("Here you can define HTML Panel 2 section title on homepage",$themename)
                ),
                array( "name" => esc_html__("HTML Panel 2 section description",$themename),
                    "id" => $shortname."_panel_2_description",
                    "std" => 'HTML Panel 2 description',
                    "type" => "text",
                    "validation_type" => "nohtml",
                    "desc" => esc_html__("Here you can define HTML Panel 2 section description on homepage",$themename)
                ),
            //------------------------------------
